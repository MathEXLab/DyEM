...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/home/dynamical_embedding/data/ks/u.npy')
    parser.add_argument('--start_from', type=int, default=10000)
    ...
    data = data[args.start_from:,...]
    print(f"Start from {args.start_from}, data shape {data.shape}")
